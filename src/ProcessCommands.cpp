...
void selectUserDefinitionsFile() {
    ...
    struct FOD : OpenDialogBase {
        ...
        STDMETHODIMP OnFileOk(IFileDialog*) override {
            ...
            if (userfile) {
                ...
                if (!userrules.is_discarded()) return S_OK;
            }
            HWND hw = 0;
            ...
            TaskDialog(hw, 0, L"Compose: Select a user definitions file", L"Invalid JSON file",
    ...
    fod.SetTitle(L"Compose: Select a user definitions file");
